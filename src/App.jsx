    ...
    <div className="pd-overlay" onClick={onClose}>
      <div className="pd-panel" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="pd-sync-desc">
          このアプリは最初から同期先が設定されているので、特別な操作をしなくても他の端末を開くだけで自動的にデータが共有されます。
          別のSupabaseプロジェクトに繋ぎ直したい場合や、この端末だけ同期をやめたい場合に、下から変更できます。
        </p>
...
function GlobalStyle() {
  return (
    <style>{`
      ...
      .pd-budget-amount-input { display: flex; align-items: center; gap: 8px; background: var(--pd-bg); border-radius: 14px; padding: 14px 18px; }
      ...
      .pd-budget-amount-input input:focus, .pd-budget-amount-input input:focus-visible { outline: none; border: none; box-shadow: none; }
